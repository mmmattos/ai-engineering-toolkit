...
alias: node-rabbitmq
description: Review, design, and improve RabbitMQ-based applications implemented in Node.js and TypeScript for reliability, scalability, and production readiness.
interaction: chat
---
