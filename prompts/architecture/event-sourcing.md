...
> Design systems where domain state can be reconstructed from durable domain events.

# Purpose

Design systems where domain state can be reconstructed from durable domain events. Start with requirements and constraints before selecting technologies.
