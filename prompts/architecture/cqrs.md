...
> Design systems that deliberately separate command processing from query models when justified.

# Purpose

Design systems that deliberately separate command processing from query models when justified. Start with requirements and constraints before selecting technologies.
